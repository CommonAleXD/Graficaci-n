...
## Instrucciones
*Utilizar OpenGL y flujo óptico para generar un mapa 3D que se pueda recorrer*
...
radius = 50.0
theta = 0.0  # Ángulo horizontal 
phi = 45.0  # Ángulo vertical
camera_target = [0.0, 0.0, 0.0]  # Punto central a observar
camera_speed = 0.1  
zoom_speed = 2.0  
