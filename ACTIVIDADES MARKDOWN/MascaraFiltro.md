# Actividad Filtro con Seguimiento

## Instrucciones
*Utiliza los Haarcascades para que una figura se posicione en un lugar concreto del rostro.*
...
# Cargar la máscara que deseas agregar 
mascara = cv2.imread('calaverita.webp', cv2.IMREAD_UNCHANGED)  
...
### Resultados
![](Resultados/mascaraFea1.png)

![](Resultados/mascaraFea2.png)

No hallaba ninguna imagen que pudiese usar como máscara y que sí me convenciera, me disculpo.