# Actividad pelota rebotando

## Instrucciones
*Utiliza OPENGL para crear una pelota que rebote en los bordes de la ventana*
...
movement_speed = 0.0005  # Velocidad del movimiento de vaivén
...
def update_motion():
    ...
    if movement_offset > 1.0:       # Limite derecho
        movement_direction = -1     # Cambiar dirección hacia la izquierda
    elif movement_offset < -1.0:    # Limite izquierdo
...
### Resultados
![](Resultados/pelota3d1.png)

![](Resultados/pelota3d2.png)